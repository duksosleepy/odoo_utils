{
    ...
    "depends": ["bus", "hr", "hr_holidays", "hr_employee_managed_departments"],
    "data": [
    ...
    "assets": {
        "web.assets_backend": [
            ...
            "hr_employee_self_only/static/src/js/employee_privacy_view_cache.js",
            "hr_employee_self_only/static/src/js/res_user_group_ids_privilege_merge_fix.js",
