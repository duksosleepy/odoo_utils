# -*- coding: utf-8 -*-
{
    ...
    "description": """
        ...
        (miền Bắc, Nam, ĐTT). Nhân viên VP chỉ thấy ngày lễ VP; nhân viên cửa
        hàng chỉ thấy ngày lễ CH (tab Cửa Hàng).

        Nhân viên cửa hàng làm việc cả tuần (7 ngày): ngày lễ CH hiển thị tham
        khảo trên lịch, không trừ vào số ngày phép.
    """,
    "depends": [
        "hr_holidays",
